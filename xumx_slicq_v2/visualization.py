...
def visualization_main():
    ...
    parser.add_argument("--fbins", type=int, default=262, help="Number of frequency bins (total or per octave, default=%(default)s)")
    parser.add_argument("--fmin", type=float, default=32.9, help="Minimum frequency in Hz (default=%(default)s)")
