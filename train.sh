...
python scripts/train.py \
	...
	--output "${outdir}" \
	--source-augmentations gain channelswap # --skip-statistics --debug-plots --print-shape --patience=1000 --fixed-start=13
...
python scripts/train.py \
	...
	--output "${outdir}" \
	--source-augmentations gain channelswap # --skip-statistics --debug-plots --print-shape --patience=1000 --fixed-start
